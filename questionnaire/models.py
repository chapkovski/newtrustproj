...
class Constants(BaseConstants):
    ...
    OCCUPATION_STATUS_CHOICES = [
        ...
        [10, _('Фермер')],
        [11, _('Предприниматель')],
        [12, _('Работаете на предприятии, в организации, колхозе, совхозе, кооперативе')],
        [13, _('Работаете не на предприятии, в организации, учреждении, колхозе, совхозе, кооперативе')],
        [14, _('Другое')],
        HARD_TO_SAY_CHOICE
    ]
...
class Player(BasePlayer):
    ...
    freedom = models.PositiveIntegerField(
        ...
        widget=LikertWidget(
         ...
         До какой степени эти характеристики применимы к Вам и Вашей жизни?"""),
            label=_(
                """Для ответа выберите значение на шкале от 0 до 10, где 0 означает "у меня нет свободы выбора", а 10
    ...
    competition = models.PositiveIntegerField(
        ...
        widget=LikertWidget(
            ...
            label=_(
                """Для ответа выберите значение на шкале от 0 до 10, где 0 означает, что «конкуренция вредна, 
