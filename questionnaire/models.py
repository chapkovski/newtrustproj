...
class Player(BasePlayer):
    ...
    motivation_part1 = models.TextField(
        label=_("""Пожалуйста, вспомните ваши решения в части 1 исследования.
    ...
    motivation_part2 = models.TextField(
        label=_("""Пожалуйста, вспомните ваши решения в части 2 исследования.
    ...
    where_to_move_WP3120 = models.StringField(
        blank=True,
        label='Если вы с высокой долей вероятности переедете, то в какой город или область вы хотели бы переехать?',
