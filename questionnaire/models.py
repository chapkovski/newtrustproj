...
class Player(BasePlayer):
    ...
    religion_moral = models.PositiveIntegerField(
        label=_("""Насколько Вы согласны со следующим утверждением? _("Люди, исповедующие другие религии, вероятно, 
    ...
    freedom = models.PositiveIntegerField(
        label=_("""Некоторые люди чувствуют, что они обладают полной свободой выбора и контролируют свою жизнь, в
         ...
         характеристики применимы к Вам и Вашей жизни? Для ответа выберите значение на шкале от 0 до 10, где 0 означает _("у меня нет свободы выбора"), а 10
         означает _("у меня полная свобода выбора"):.
         """),
    ...
    positive_reciprocity = models.PositiveIntegerField(
        label=_("""_("Когда кто-либо мне помогает я стараюсь ответить тем же.") Справедливо ли это суждение в отношении Вас? Для ответа выберите значение на шкале от 0 до 10,
    ...
    negative_reciprocity = models.PositiveIntegerField(
        label=_("""_("Если со мной поступили несправедливо, я отомщу при первом же удобном случае, даже если это дорого мне обойдется.")  Справедливо ли это суждение в отношении Вас? Для ответа выберите значение на шкале от 0 до 10,
         где 0 означает, что Вы «совершенно не готовы так поступать», а 10 означает, что Вы «готовы поступать именно так»"""),
        choices=Constants.FEATURE_CHOICES,
        widget=widgets.RadioSelectHorizontal()
    )
